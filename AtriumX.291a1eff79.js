    ...
    `}var Vr=String.fromCharCode(8212);function Wr(t){if(!t)return null;var e=String(t).match(/([0-9.]+)\s*([MBK])?/i);if(!e)return null;var n=parseFloat(e[1]);if(!isFinite(n))return null;var r=(e[2]||"M").toUpperCase();return"B"===r?1e3*n:"K"===r?n/1e3:n}function Yr(t){var e=String(t||"").match(/([₪$€£])/);return e?e[1]:"₪"}function qr(t,e){if(null==t||!isFinite(t))return Vr;if(0===t)return e+"0";var n=t<0?String.fromCharCode(8722):"",r=Math.abs(t);return r>=1e3?n+e+(r/1e3).toFixed(2)+"B":n+e+r.toFixed(1)+"M"}function Jr(t,e){if(null==t||!isFinite(t))return Vr;if(0===t)return e+"0";var n=Math.abs(t);return n>=1e9?e+(n/1e9).toFixed(2)+"B":n>=1e6?e+(n/1e6).toFixed(2)+"M":n>=1e3?e+Math.round(n/1e3)+"K":e+Math.round(n)}function zr(t){if(!t)return"";var e=String(t).trim();if(/^\d{1,2}\/\d{4}$/.test(e))return e.replace(/^(\d)\//,"0$1/");var n=e.match(/(\w+)\s+(\d{4})/);if(!n)return"";var r=["january","february","march","april","may","june","july","august","september","october","november","december"],a=r.indexOf(n[1].toLowerCase());return a<0?"":String(a+1).padStart(2,"0")+"/"+n[2]}function Xr(t,e){var n=null,r=null,a=!1,i="₪",o="",l="",s=null;if(t){var u=t.closed||{},c=t.yield||{};if(i=Yr(u.numeralDisplay)||Yr(c.netFlowsDisplay)||"₪",o=c.projectingLabel||c.prevMonthLabel||u.label||"",l=c.projectingMonthSlash||zr(c.projectingLabel)||zr(c.prevMonthLabel)||"",!l&&e&&(l=zr(e)),null!=c.prevAmountExact){var d=Number(c.prevAmountExact);isFinite(d)&&(n=d/1e6)}if(null==n&&c.prevAmountDisplay){var f=Wr(c.prevAmountDisplay);null!=f&&(n=f)}if(null==n)if(null!=u.numeralExact)n=Number(u.numeralExact)/1e6;else{var p=Wr(u.numeralDisplay);null!=p&&(n=p)}if(null!=c.netFlowsValue)r=Number(c.netFlowsValue)/1e6;else{var h=Wr(c.netFlowsDisplay);null!=h&&(r=h)}null!=r&&!0===c.netFlowsConfirmed&&(a=!0),s=c.lastResult||null}return{prev:n,net:r,netConfirmed:a,cur:i,prevMonthLabel:o,projectingMonthSlash:l,lastResult:s}}function Qr(t){var e=0,n=0,r=0,a=0,i=[];return(t||[]).forEach(function(t){if(t&&"number"==typeof t.amount&&t.amount>0&&t.direction&&t.settled){var o=ui(t.label||t.name||t.lp||"?"),l="USD"===t.currency,s="redemption"===t.direction?"red":"dep";i.push({lp:o,amount:t.amount,currency:l?"USD":"ILS",kind:s}),l?"red"===s?a+=t.amount:r+=t.amount:"red"===s?n+=t.amount:e+=t.amount}}),i.sort(function(t,e){return e.amount-t.amount}),{ilsDep:e,ilsRed:n,usdDep:r,usdRed:a,netIls:e-n,netUsd:r-a,items:i}}function Zr(t){var e=t&&Array.isArray(t.rows)?t.rows:Array.isArray(t)?t:[],n=t&&t.totals||{};return{rows:e,totals:n}}function ta(t,e){return t&&"number"==typeof t.netConverted&&isFinite(t.netConverted)?t.netConverted:t&&"number"==typeof t.netIls&&isFinite(t.netIls)?t.netIls:e?e.netIls:0}function ea(t,e,n){var r=String(null==t?"":t).replace(/[^0-9.]/g,""),a=parseFloat(r);if(isNaN(a)||a<=0||null==e||e<=0)return null;var i=!1;a>1e4&&(a/=1e6,i=!0);var o=null==n?0:n,l=a/(e+o)-1;return{closing:a,pct:l,rescaled:i}}function na(t){var e=t>=0?"+":"";return e+(100*t).toFixed(2)+"%"}Ht=t.bind(n);var ra=Bt,aa=6e4,ia={fetchedAt:0};function oa(){var t=rt.schedule.value,e=s({fetching:!1,error:null,fetchedAt:ia.fetchedAt}),n=e[0],r=e[1],a=s(0),o=(a[0],a[1]),u=s({}),c=u[0],d=u[1],f=s({}),p=f[0],h=f[1],v=s({}),m=v[0],g=v[1],_=l({}),y=s(null),b=y[0],$=y[1],w=l(null),k=s({}),x=k[0],S=k[1],A=s({}),C=A[0],N=A[1],D=l(null),E=l(0);function P(t){return function(e){var n={};for(var r in e)n[r]=e[r];return n[t]=!0,n}}function O(t){return function(e){var n={};for(var r in e)n[r]=e[r];return delete n[t],n}}function T(t){var e=++E.current;r(function(t){return{fetching:!0,error:null,fetchedAt:t.fetchedAt}}),Ut.scheduleState({}).then(function(t){e===E.current&&(t?(rt.schedule.value=t,ia.fetchedAt=Date.now(),r({fetching:!1,error:null,fetchedAt:ia.fetchedAt})):r(function(t){return{fetching:!1,error:"schedule returned no state",fetchedAt:t.fetchedAt}}))}).catch(function(n){e===E.current&&(Mt("schedule:fetch:"+(t||""),n),r(function(t){return{fetching:!1,error:n&&n.message||String(n),fetchedAt:t.fetchedAt}}))})}function L(t){D.current&&clearTimeout(D.current),D.current=setTimeout(function(){D.current=null,T(t||"debounced")},600)}function I(t){var e=rt.schedule.value;e&&(rt.schedule.value={asOf:e.asOf,tasks:(e.tasks||[]).filter(function(e){return e.id!==t}),events:e.events||[],board:(e.board||[]).filter(function(e){return!("task"===e.kind&&e.id===t)})})}function R(t,e){var n=rt.schedule.value;n&&(rt.schedule.value={asOf:n.asOf,tasks:(n.tasks||[]).map(function(n){return n&&n.id===t?Object.assign({},n,{title:e}):n}),events:n.events||[],board:(n.board||[]).map(function(n){return n&&"task"===n.kind&&n.id===t?Object.assign({},n,{title:e}):n})})}function F(t){t&&t.id&&!c[t.id]&&!p[t.id]&&(d(P(t.id)),Ut.completeTask(t.id).then(function(e){if(!e||!1===e.ok)return d(O(t.id)),void ra("Could not complete: "+(e&&e.error||"unknown"),"error");I(t.id),d(O(t.id)),ra("✓ "+(t.title||"Done"),"success"),L("completed")}).catch(function(e){d(O(t.id)),Mt("schedule:complete",e),ra("Could not confirm completion, restored the task","error")}))}function M(t){var e=_.current;e[t]&&(clearTimeout(e[t]),delete e[t]),g(O(t))}function j(t){if(t&&t.id&&!c[t.id]&&!p[t.id]){if(!m[t.id])return g(P(t.id)),void(_.current[t.id]=setTimeout(function(){delete _.current[t.id],g(O(t.id))},3e3));M(t.id),h(P(t.id)),Ut.removeTask(t.id).then(function(e){if(!e||!1===e.ok)return h(O(t.id)),void ra("Could not delete: "+(e&&e.error||"unknown"),"error");I(t.id),h(O(t.id)),ra("Deleted "+(t.title||"task"),"success"),L("deleted")}).catch(function(e){h(O(t.id)),Mt("schedule:delete",e),ra(e&&e.rpcTimeout?"Could not confirm delete, restored the task":"Server error deleting task","error")})}}function K(t){if(t&&t.id&&!C[t.id]&&!c[t.id]&&!p[t.id]){var e=t.when?t.when.substring(0,10):"",n=document.createElement("input");n.type="date",n.value=e||"",n.className="sched-row__reschedule-input",n.style.position="absolute",n.style.left="-9999px",document.body.appendChild(n);var r=!1,a=!1;n.addEventListener("change",function(){r=!0;var a=n.value||"";i(),a&&a!==e&&(N(P(t.id)),Ut.updateTask(t.id,{due:a}).then(function(e){N(O(t.id)),e&&!1!==e.ok?(ra("Rescheduled to "+a,"success"),L("rescheduled")):ra("Could not reschedule: "+(e&&e.error||"unknown"),"error")}).catch(function(e){N(O(t.id)),Mt("schedule:reschedule",e),ra("Server error rescheduling","error")}))}),n.addEventListener("cancel",i),n.addEventListener("blur",function(){setTimeout(function(){r||i()},200)}),setTimeout(i,8e3);try{n.showPicker?n.showPicker():n.focus()}catch(t){n.focus()}}function i(){a||(a=!0,n.parentNode&&document.body.removeChild(n))}}function U(t){!t||!t.id||x[t.id]||c[t.id]||p[t.id]||b!==t.id&&(w.current={id:t.id,prev:t.title||"",done:!1},$(t.id))}function B(t){var e=w.current;if(e&&!e.done){e.done=!0,$(null);var n=String(null==t?"":t).trim();if(n&&n!==e.prev){var r=e.id,a=e.prev;R(r,n),S(P(r)),Ut.updateTask(r,{title:n}).then(function(t){if(S(O(r)),!t||!1===t.ok)return R(r,a),void ra("Rename failed: "+(t&&t.error||"unknown"),"error");ra("Renamed","success"),L("renamed")}).catch(function(t){S(O(r)),R(r,a),Mt("schedule:rename",t),ra("Server error renaming","error")})}}}function H(){var t=w.current;t&&!t.done&&(t.done=!0,$(null))}i(function(){var t=!!rt.schedule.value&&ia.fetchedAt>0&&Date.now()-ia.fetchedAt<aa;t||T("mount");var e=setInterval(function(){"undefined"!=typeof document&&document.hidden||o(function(t){return t+1})},3e4);return function(){clearInterval(e),D.current&&clearTimeout(D.current);var t=_.current;for(var n in t)t[n]&&clearTimeout(t[n]);_.current={}}},[]);var G,V=Date.now();function W(e){var n=va(t,e),r=n?ha(n.notes):null,a=!!m[e.id];return Ht`
        <span class="sched-row__acts">
          ...
          <span class=${"sched-row__title sched-row__title--edit"+(x[t.id]?" is-saving":"")}
                ...
                onKeyDown=${function(e){"Enter"===e.key&&(e.preventDefault(),U(t))}}>${t.title||e}</span>`:Ht`<span class="sched-row__title" dir="auto">${t.title||e}</span>`}function q(t){var e="task"===t.kind,n=t.when?new Date(t.when):null,r=n&&n.getTime()<V,a=n?sa(t.when,V):t.dueRelative||"",i=ua(a),o=e&&!!t.id,l=Ht`
        <span class=${"sched-row__time"+(r?" is-past":"")}>${n?da(n):String.fromCharCode(8212)}</span>
        <span class="sched-row__date">${n?pa(n,V):""}</span>`;return Ht`
        <div key=${t.kind+":"+t.id}
        ...
        </div>`;else if(t){var z=la(t.board),X=z.dated,Q=z.undated;G=Ht`
      ...
      `}else G=Ht`
        ...
        </div>`;var Z="";if(t){Z=(t.tasks||[]).length+" tasks · "+(t.events||[]).length+" events";var tt=ca(n.fetchedAt,V);tt&&(Z+="  "+tt)}else Z=n.error?"unavailable":"loading";return Ht`
